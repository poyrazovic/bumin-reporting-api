...
class Accordion extends Component {
  /* eslint-disable react/prop-types, class-methods-use-this, array-callback-return, react/no-array-index-key */
  constructor(props) {
    super(props);
    this.state = {
      collapse: null
  ...
  render() {
    ...
    if (items) {
      return items.map((el, index) => {
                    ...
                    <div className="row d-flex align-items-center">
                      <div className="heading-text-wrapper-left col-10">
                        <h3 className="text-primary">
                          {el.customerInfo.billingFirstName ? el.customerInfo.billingFirstName : ''}{' '}
                      ...
                      <div className="heading-text-wrapper-right col-10">
                        <p>
                          Status:
                          <span className={['font-weight-bold', this.statusChecker(el)].join(' ')}>
        ...
        return <Card>Result is not found!</Card>;
      });
    }
    return <Card>Result is not found!</Card>;
  }
